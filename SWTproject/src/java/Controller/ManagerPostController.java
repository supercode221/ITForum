 ...
 * @author HP
 */
@WebServlet(name = "ManagerPostController", urlPatterns = {"/posts"})
public class ManagerPostController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        userLogin = (User) session.getAttribute("adminLogin");
        if (userLogin == null) {
    ...
    private void showAddForm(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException {
        ...
        request.getRequestDispatcher("add-post-admin.jsp").forward(request, response);
    }
    ...
    private void showEditForm(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException {
        ...
        request.getRequestDispatcher("edit-form-admin.jsp").forward(request, response);
    }
    ...
    private void listPosts(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException {
        try {
            ...
            request.getRequestDispatcher("post-list-admin.jsp").forward(request, response);
        } catch (Exception e) {
